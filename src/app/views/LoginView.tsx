          ...
          <form className="space-y-6" onSubmit={submit}>
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-[#7b8bda] focus:border-[#7b8bda] sm:text-sm" placeholder="seu@email.com" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input type={showPassword ? "text" : "password"} required value={password} onChange={(e) => setPassword(e.target.value)} className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-[#7b8bda] focus:border-[#7b8bda] sm:text-sm" placeholder="••••••••" />
